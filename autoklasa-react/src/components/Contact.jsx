...
const CONTACTS = [
  {
    ...
    label: 'آدرس',
    value: <>خیابان استارومیه‌یسکا ۶۹<br />۴۴-۱۰۹ گلیویتسه</>,
  },
  {
    ...
    label: 'تلفن',
    value: <a href="tel:+48579779220" dir="ltr">+48 579 779 220</a>,
  },
  {
    ...
    label: 'ایمیل',
    value: <a href="mailto:kontakt@autoklasa.pl" dir="ltr">kontakt@autoklasa.pl</a>,
  },
  {
